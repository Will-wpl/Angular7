...
@Component({
  selector: 'rose-charts',
  templateUrl: './rosecharts.component.html',
  providers:[
    {provide: OWL_DATE_TIME_FORMATS, useValue: MY_MOMENT_FORMATS}
  ]
})
export class RosechartsComponent implements OnInit {
  @Input() serial;
  @Input() allserial;
  ...
  createCharts() {
    ...
    setTimeout(() => {
      const chart = echarts.init(document.getElementById('chart_rose'));
      chart.clear();
