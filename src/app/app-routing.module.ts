...
const routes: Routes = [
  ...
  { path: 'structure/YYL',  component: StructurehomeComponent },
  { path: 'structure/TDWY',  component: StructurehomeComponent },
  { path: 'structure/SSFWY',  component: StructurehomeComponent },
  { path: 'structure/ZZWY',  component: StructurehomeComponent },
  { path: 'structure/ZLWY',  component: StructurehomeComponent },
  { path: 'structure/QDWY',  component: StructurehomeComponent },
  { path: 'structure/GJFS',  component: StructurehomeComponent },
  { path: 'structure/HNTLF',  component: StructurehomeComponent },
  { path: 'environment/WD',  component: StructurehomeComponent },
  { path: 'environment/FZJC',  component: StructurehomeComponent },
  { path: 'environment/SDJC',  component: StructurehomeComponent },
  { path: 'environment/DZJC',  component: StructurehomeComponent },
